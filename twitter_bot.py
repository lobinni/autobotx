...
def generate_reply(tweet_text):
    ...
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "You are a smart and funny Twitter chatbot."},
...
def interact_with_tweets(api, client, account_number):
    """Like, retweet, and reply to target account's tweets."""
    try:
